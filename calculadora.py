...
boton0.grid(row = 5,column = 2,columnspan=2, padx = 5, pady = 5)
boton_mult.grid(row = 2,column = 0, padx = 5, pady = 5)
boton_sum.grid(row = 3,column = 0, padx = 5, pady = 5)
boton_igual.grid(row = 5,column = 1, padx = 5, pady = 5)
boton_punto.grid(row = 5,column = 0, padx = 5, pady = 5)
boton_rest.grid(row = 4,column = 0, padx = 5, pady = 5)
